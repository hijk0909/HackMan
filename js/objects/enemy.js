...
const GENERATING_PERIOD = 120;
const GENERATING_TINT = 0x20ff20;
...
export class Enemy extends Movable {
    ...
    constructor(scene){
        ...
        this.generating_count = GENERATING_PERIOD;
    }

    update(){
        if (this.generating){
            this.generating_count -= 1;
            if (this.generating_count < 0){
                this.generating = false;
            } else {
                super.update();
                return;
    ...
    set_generating(){
        ...
        this.generating_count = GENERATING_PERIOD;
        this.sprite.setTint(GENERATING_TINT);
