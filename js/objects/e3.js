...
export class E3 extends Enemy {
    ...
    constructor(scene){
        ...
        this.speed = 4;
        this.tribe = GLOBALS.ENEMY.TRIBE.E3;
    }

    init(type, pos){

        const type_defs = [
            {type:0, anims: 'e3_anims_0', anims_start: 0, anims_end: 3, bullet:null, score:300},
            {type:1, anims: 'e3_anims_1', anims_start: 4, anims_end: 7, bullet:B1, score:400},
            {type:2, anims: 'e3_anims_2', anims_start: 8, anims_end:11, bullet:B2, score:600},
            {type:3, anims: 'e3_anims_3', anims_start:12, anims_end:15, bullet:B3, score:500}
        ];
