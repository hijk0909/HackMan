...
export class E1 extends Enemy {
    ...
    constructor(scene){
        ...
        this.tribe = GLOBALS.ENEMY.TRIBE.E1;
    }

    init(type, pos){

        const type_defs = [
            {type:0, anims: 'e1_anims_0', anims_start:0, anims_end:4,  bullet:null, score:100},
            {type:1, anims: 'e1_anims_1', anims_start:5, anims_end:9,  bullet:B1, score:150},
            {type:2, anims: 'e1_anims_2', anims_start:10, anims_end:14, bullet:B2, score:300},
