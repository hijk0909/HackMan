...
export class AssetLoader extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.spritesheet('ss_bg', 'assets/images/ss_bg.png', {
            frameWidth: 100, frameHeight: 100, endFrme : 4});
        // パネル
        ...
        this.load.image('cursor3', 'assets/images/cursor3.png');
        // キャラクター・効果
        ...
        this.load.audio('se_item_none', './assets/audio/se/se_item_none.mp3');
        this.load.audio('se_item_invincible', './assets/audio/se/se_item_invincible.mp3');
        this.load.audio('se_trap', './assets/audio/se/se_trap.mp3');
        this.load.audio('se_break', './assets/audio/se/se_break.mp3');
        this.load.audio('se_unlock', './assets/audio/se/se_unlock.mp3');
    ...
    create() {
        GameState.sound = {
            ...
            se_item_none       : this.sound.add('se_item_none', { volume: 0.7 }),
            se_item_invincible : this.sound.add('se_item_invincible', { volume: 1.0 }),
            se_trap            : this.sound.add('se_trap', { volume: 1.0 }),
            se_break           : this.sound.add('se_break', { volume: 0.4 }),
            se_unlock          : this.sound.add('se_unlock', { volume: 1.0 }),
